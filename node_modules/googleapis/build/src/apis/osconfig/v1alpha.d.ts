...
export declare namespace osconfig_v1alpha {
    ...
    export class Resource$Projects$Locations$Instances$Ospolicyassignments {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        getReport(params: Params$Resource$Projects$Locations$Instances$Ospolicyassignments$Getreport, options: StreamMethodOptions): GaxiosPromise<Readable>;
        getReport(params?: Params$Resource$Projects$Locations$Instances$Ospolicyassignments$Getreport, options?: MethodOptions): GaxiosPromise<Schema$OSPolicyAssignmentReport>;
        getReport(params: Params$Resource$Projects$Locations$Instances$Ospolicyassignments$Getreport, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        getReport(params: Params$Resource$Projects$Locations$Instances$Ospolicyassignments$Getreport, options: MethodOptions | BodyResponseCallback<Schema$OSPolicyAssignmentReport>, callback: BodyResponseCallback<Schema$OSPolicyAssignmentReport>): void;
        getReport(params: Params$Resource$Projects$Locations$Instances$Ospolicyassignments$Getreport, callback: BodyResponseCallback<Schema$OSPolicyAssignmentReport>): void;
        getReport(callback: BodyResponseCallback<Schema$OSPolicyAssignmentReport>): void;
    }
    export interface Params$Resource$Projects$Locations$Instances$Ospolicyassignments$Getreport extends StandardParameters {
        /**
         * Required. API resource name for OS policy assignment report. Format: `/projects/{project\}/locations/{location\}/instances/{instance\}/osPolicyAssignments/{assignment\}/report` For `{project\}`, either `project-number` or `project-id` can be provided. For `{instance_id\}`, either Compute Engine `instance-id` or `instance-name` can be provided. For `{assignment_id\}`, the OSPolicyAssignment id must be provided.
         */
        name?: string;
